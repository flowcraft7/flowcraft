  ...
  return (
    <section className="border-b border-line py-24">
      <div className="mx-auto max-w-xl px-6 text-center lg:px-8">
        ...
        {transcript && (
          <div className="mt-8 rounded-lg border border-line bg-white p-6 text-left">
        ...
        {reply && (
          <div className="mt-4 rounded-lg border border-signal bg-signal-dim p-6 text-left">
        ...
        {showForm && (
          <div className="mt-6 rounded-lg border border-automate bg-white p-6 text-left">
            {formStatus === "success" ? (
              <p className="text-sm font-medium text-ink">Thanks — we&apos;ll reach out shortly.</p>
            ) : (
