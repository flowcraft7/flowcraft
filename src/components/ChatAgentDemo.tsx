...
export default function ChatAgentDemo() {
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I'm Bella's Salon's AI assistant. Ask me about hours, services, or booking." },
  ]);
  ...
  return (
    <div className="mt-6 rounded-lg border border-line bg-paper p-4">
      <p className="font-mono text-xs uppercase tracking-wide text-ink-soft">Live demo — try it</p>
        ...
        {messages.map((msg, i) => (
          <motion.div
            ...
            className={`rounded-md px-3 py-2 text-sm ${
              msg.role === "user" ? "ml-8 bg-ink text-paper" : "mr-8 bg-white text-ink"
            }`}
          >
            {msg.content}
          </motion.div>
